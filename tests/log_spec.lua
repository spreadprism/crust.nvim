...
describe("log", function()
	...
	it("writes U for sent and P for received lines", function()
		local log = Log.new("s", dir)
		...
		assert.is_truthy(lines[1]:match('^U %- {"type":"prompt","message":"hi"} '))
		assert.is_truthy(lines[2]:match('^P %- {"type":"response","success":true} '))
	end)
